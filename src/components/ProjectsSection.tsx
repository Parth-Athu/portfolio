...
const projects = [
  ...
  { title: "Dockerized Microservices Demo", category: "Docker · Python · Flask", span: "lg:col-span-1 lg:row-span-1", color: "from-primary/15 to-[hsl(235,80%,60%)]/10" },
  { title: "Kubernetes Deployment Project", category: "Kubernetes · Helm", span: "lg:col-span-1 lg:row-span-2", color: "from-[hsl(235,80%,60%)]/20 to-primary/5" },
  { title: "Infrastructure as Code Setup", category: "Terraform · AWS", span: "lg:col-span-1 lg:row-span-1", color: "from-primary/20 to-primary/10" },
